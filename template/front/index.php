			...
			<section class="home-about-area section-gap">
				...
				<img class="about-img" src="<?=get_template_directory(dirname(__FILE__),'')?>img/about-img.png" alt="">
			</section>
			<!-- End home-about Area -->
					...
					<div class="row">
						<div class="col-lg-3 col-md-6">
							<div class="single-cat-item">
								<div class="thumb">
									<img class="img-fluid" src="<?=get_template_directory(dirname(__FILE__),'')?>img/c1.jpg" alt="">
								</div>	
								<a href="#"><h4>Kue Lebaran</h4></a>
								<p>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-cat-item">
								<div class="thumb">
									<img class="img-fluid" src="<?=get_template_directory(dirname(__FILE__),'')?>img/c2.jpg" alt="">
								</div>	
								<a href="#"><h4>Parsel</h4></a>
								<p>
									inappropriate behavior is often laughed off as “boys will be.
								</p>
							</div>
